...
import type { EstimateDocument } from "@/lib/types";
...
export default function LaborPage() {
  ...
  const totalLaborCost = useMemo(() => summaries.reduce((sum, s) => sum + s.totalCost, 0), [summaries]);
  const totalHours = useMemo(() => summaries.reduce((sum, s) => sum + s.hours, 0), [summaries]);
